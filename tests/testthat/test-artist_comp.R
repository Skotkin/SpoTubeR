...
#testthat::test_that("two messages works", {
  ...
  #testthat::expect_message(object = artist_comp('https://open.spotify.com/artist/6BRxQ8cD3eqnrVj6WKDok8?si=ImCQ7g50TBaQQ2ikChEZdg'), regexp = "Retrieving Spotify statistics associated with.*")
  #testthat::expect_message(object = artist_comp('https://open.spotify.com/artist/6BRxQ8cD3eqnrVj6WKDok8?si=ImCQ7g50TBaQQ2ikChEZdg'), regexp = "Retrieving YouTube subscriber count associated with.*")
#})
